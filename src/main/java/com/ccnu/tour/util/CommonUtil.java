...
public class CommonUtil {
     ...
     * @return
     */
    public static JSONObject errorJson(ErrorEnum errorEnum, JSONObject jsonObject) {
        JSONObject resultJson = new JSONObject();
        resultJson.put("returnCode", errorEnum.getErrorCode());
        resultJson.put("returnMsg", errorEnum.getErrorMsg());
     ...
     * @param list 查询分页对象list
     */
    public static JSONObject successPage(JSONObject list) {
        JSONObject result = successJson();
...
//            }
            ...
            requestJson.put(paramName, ParameterValue);
        }

        // 转换时间为时间戳格式 like 2018-11-07T1600:00:00.000Z -> 1541606400
        return requestJson;
    }
